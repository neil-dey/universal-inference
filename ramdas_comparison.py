...
#plt.scatter(nom_coverages, gibbs_spec_coverages, color = "red", marker = "^", label = "GUI (Beta)")
#plt.scatter(nom_coverages, gibbs_misspec_coverages, color = "gold", marker = "s", label = "GUI (Normal)")
plt.scatter(nom_coverages, gibbs_eq1_coverages, color = "blue", label = "Eq. (1) result")
plt.scatter(nom_coverages, gibbs_eq1_over2_coverages, color = "red", marker = "^", label = "Half Eq. (1) result")
